...
BBox = (41.65900629, 42.0128288601, -87.535052, -87.8367650119)
fig, ax = plt.subplots(figsize=(8, 7))

#use a for loop and plot the longitudes and latitudes of the path. (Will need to call path functions)\
